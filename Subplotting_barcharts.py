...
axs[1,1].bar(x - width/2, employees_2024, color=color1, edgecolor='black', width=width)
axs[1,1].bar(x + width/2, employees_2025, color=color2, edgecolor='black', width=width)
...
for i in range(len(departments)):
    # Week 2024 bars
    axs[1,1].text(x[i]-width/2, employees_2024[i]+0.5, '2024', ha='center', va='bottom')
    # Week 2025 bars
    axs[1,1].text(x[i]+width/2, employees_2025[i]+0.5, '2025', ha='center', va='bottom')
